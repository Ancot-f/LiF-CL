"""
CODA-Prompt ViT - 带分解注意力 Prompt 的 Vision Transformer
===========================================================
基于 BLIP 代码库的 ViT 实现, 增加 CODA-Prompt 机制用于持续学习.

CODA-Prompt 在每一层通过外部 prompt 模块动态生成 prompt K/V 对,
以 K/V 前缀形式拼接到注意力的 key 和 value 中.

Based on vit from blip code base: https://github.com/salesforce/BLIP
"""
import math
import logging
import torch
