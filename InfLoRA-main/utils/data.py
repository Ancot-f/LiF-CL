...
class iCUB(iData):
    ...
    def download_data(self):
        train_dir = os.path.join(resolve_data_path("cub"), "train")
        test_dir = os.path.join(resolve_data_path("cub"), "test")
...
class iCIFAR10(iData):
    ...
    def download_data(self):
        data_path = self.args.get('data_path') or resolve_data_path("cifar10")
...
class iCIFAR100(iData):
    ...
    def download_data(self):
        data_path = self.args.get('data_path') or resolve_data_path("cifar100")
...
class iIMAGENET_R(iData):
    ...
    def download_data(self):
        data_path = self.args.get('data_path') or resolve_data_path("imagenet-r")
        # load splits from config file
        if not os.path.exists(os.path.join(data_path, 'train')) and not os.path.exists(os.path.join(data_path, 'train')):
            self.dataset = datasets.ImageFolder(data_path, transform=None)
        ...
        train_data_config = datasets.ImageFolder(os.path.join(data_path, 'train')).samples
        test_data_config = datasets.ImageFolder(os.path.join(data_path, 'test')).samples
    ...
    def split(self):
        train_folder = os.path.join(resolve_data_path("imagenet-r"), 'train')
        test_folder = os.path.join(resolve_data_path("imagenet-r"), 'test')
...
class iIMAGENET_A(iData):
    ...
    def download_data(self):
        train_dir = os.path.join(resolve_data_path("imagenet-a"), "train")
        test_dir = os.path.join(resolve_data_path("imagenet-a"), "test")
